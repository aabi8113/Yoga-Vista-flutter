...
class CardFiveScreen extends StatefulWidget {
  const CardFiveScreen({Key? key}) : super(key: key);

  @override
  _CardFiveScreenState createState() => _CardFiveScreenState();
}

class _CardFiveScreenState extends State<CardFiveScreen> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    FadeTransition(
                      ...
                      child: ScaleTransition(
                        ...
                        child: ClipOval(
                          child: Image.asset(
                            'assets/images/meditation_cards/yoga_5.webp',
                            width: 180.0,
                            height: 180.0,
                            fit: BoxFit.cover,
                          ),
                    ...
                    FadeTransition(
                      ...
                      child: Text(
                        'Instructions:\n'
                            ...
                            '4. Continue to flow between these two poses, synchronizing your breath with your movements.\n'
                            '5. Perform for several breaths, focusing on the stretch and movement of your spine.',
